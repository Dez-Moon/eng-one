...
import PassingTest from "../Tests/components/PassingTest/PassingTest";
import TestResult from "../Tests/components/TestResult/TestResult";
import TestCreation from "../Tests/components/TestСreation/TestCreation";
import styles from "./styles.module.scss";
import SettingsIcon from "@mui/icons-material/Settings";

const LevelDetection = () => {
  ...
  return (
    <div className={styles.levelDetection}>
      {!creatingTest ? (
        passingTest === null ? (
